...
function resto_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'      => 'WordCounter',
			'slug'      => 'WordCounter',
			'source' => 'https://github.com/codingbysaikat/WordCounter/archive/refs/heads/main.zip',
			'required'  => false,
		),
		// array(
		// 	'name'               => 'carbon-fields', // The plugin name.
		// 	'slug'               => 'carbon-fields', // The plugin slug (typically the folder name).
		// 	'source'             => get_theme_file_path('/lib/plugins/carbon-fields.zip'), // The plugin source.
	 ...
	 */
	$config = array(
		'id'           => 'resto',                 // Unique ID for hashing notices for multiple instances of TGMPA.
