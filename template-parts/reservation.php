...
?>
<section id="gtco-reservation" class="bg-fixed bg-white section-padding overlay" style="background-image: url(<?php echo get_template_directory_uri().'/assets/img/reservation-bg.jpg'?>);">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
